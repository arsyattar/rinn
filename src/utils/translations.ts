      ...
      plans: [
        {
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Bust Up* (Rp 140.000).',
        },
        {
          id: 'genshin-icon',
        ...
        },
        {
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Half Body* (Rp 250.000).',
        },
        {
          id: 'full-body',
          name: 'Full Body',
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Full Body* (Rp 300.000).',
        },
        {
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Character Sheet (Simple)* (Mulai dari Rp 350.000).',
        },
        {
          id: 'genshin-drip',
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Genshin Drip Marketing* (Rp 400.000).',
        },
        {
          ...
          waTemplate: 'Halo Amai Vaelithys! Saya ingin memesan komisi *Character Sheet (Overdetailed)* (Mulai dari Rp 700.000).',
        },
      ],
    },
    testimonials: {
